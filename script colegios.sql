...
create table colegios_actividades(
	...
	idCharlas smallint null,
	fecha smalldatetime not null,
	numero_asistentes smallint not null,
	constraint FK_idColegio_colegios-actividades foreign key (idColegio) references colegios(idColegio)
	on delete cascade, -- on delete set default
	constraint FK_idCharlas_colegios-actividades foreign key (idCharla) references charlas(idCharlas)
